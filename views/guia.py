...
class VentanaGuia(QWidget):
    ...
    def configurar_guia_completa(self):
        ...
        <div class='seccion'>
            ...
            <div class="imagen">
                <img class="img-ajustada" src="assets/menu.png" alt="Configuración del temporizador">
            </div>
        ...
        <div class='seccion'>
            ...
            <div class="imagen">
                <img class="img-ajustada" src="assets/menu.png" alt="Pantalla de visualización del pleno">
            </div>
