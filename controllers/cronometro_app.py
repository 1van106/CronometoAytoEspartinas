...
class CronometroApp(QMainWindow):
    ...
    def mostrar_pleno(self, tipo_pleno):
        """Muestra la ventana de visualización del pleno"""
        datos = Almacenamiento.cargar_cronometros(tipo_pleno)
        if datos:
            self.ventana_visualizacion = VentanaVisualizacion(datos, tipo_pleno)
